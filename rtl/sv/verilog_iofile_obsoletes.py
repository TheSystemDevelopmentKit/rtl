...
class verilog_iofile_obsoletes:
    ...
    def verilog_stat(self):
        ...
        self.print_log(
            type="O",
            msg="Parameter verilog_stat is obsolete. Use rtl_stat instead",
        )
    ...
    def verilog_ctstamp(self):
        ...
        self.print_log(
            type="O",
            msg="Parameter verilog_ctstamp is obsolete. Use rtl_ctstamp instead",
        )
    ...
    def verilog_ptstamp(self):
        ...
        self.print_log(
            type="O",
            msg="Parameter verilog_ptstamp is obsolete. Use rtl_ptstamp instead",
        )
    ...
    def verilog_tdiff(self):
        ...
        self.print_log(
            type="O",
            msg="Parameter verilog_tdiff is obsolete. Use rtl_tdiff instead",
        )
    ...
    def verilog_statdef(self):
        ...
        self.print_log(
            type="O",
            msg="Parameter verilog_statdef is obsolete. Use rtl_statdef instead",
        )
    ...
    def verilog_fptr(self):
        ...
        self.print_log(
            type="O",
            msg="Parameter verilog_fptr is obsolete. Use rtl_fptr instead",
        )
    ...
    def verilog_fopen(self):
        ...
        self.print_log(
            type="O",
            msg="Parameter verilog_fopen is obsolete. Use rtl_fopen instead",
        )
    ...
    def verilog_fclose(self):
        ...
        self.print_log(
            type="O",
            msg="Parameter verilog_fclose is obsolete. Use rtl_fclose instead",
        )
    ...
    def verilog_connectors(self):
        ...
        self.print_log(
            type="O",
            msg="Parameter verilog_connectors is obsolete. Use rtl_connectors instead",
        )
    ...
    def verilog_io_condition(self):
        ...
        self.print_log(
            type="O",
            msg="Parameter verilog_io_condition is obsolete. Use rtl_io_condition instead",
        )
    ...
    def verilog_io_condition_append(self, **kwargs):
        ...
        self.print_log(
            type="O",
            msg="Method verilog_io_condition_append is obsolete. Use rtl_io_condition_append instead",
        )
    ...
    def verilog_io_sync(self):
        ...
        self.print_log(
            type="O",
            msg="Parameter verilog_io_sync is obsolete. Use rtl_io_sync instead",
        )
    ...
    def verilog_io(self):
        ...
        """
        self.print_log(
            type="O", msg="Parameter verilog_io is obsolete. Use rtl_io instead"
        )
        return self.rtl_io
